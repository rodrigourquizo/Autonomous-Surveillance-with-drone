...
class PersonDetectionApp:
    def __init__(self, root, window_title):
        ...
        self.btn_start_detection = tk.Button(root, text="Iniciar Detección", command=self.start_detection)
        self.btn_start_detection.pack()

        self.btn_stop_detection = tk.Button(root, text="Detener Detección", command=self.stop_detection, state=tk.DISABLED)
